...
Do not silently resolve a contradiction. Product semantics defer upward to the Foundation. Technical remediations in v0.2 supersede v0.1 technical assumptions. If same-level contracts disagree, stop the affected implementation and raise a change/clarification before coding around it.
