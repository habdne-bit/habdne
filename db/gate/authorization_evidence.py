...
RULES: tuple[Rule, ...] = (
    ...
    Rule("Slice 2 / §5.2",
         "Only the documented state machine's edges exist; others are refused",
         ("test_the_documented_path_works_end_to_end",
          ...
          "test_leaving_paused_requires_explicit_reactivation")),
    ...
    Rule("Slice 2 claim flow",
         "Claiming converts the record in place; it never duplicates it",
         ("test_claiming_converts_the_record_in_place",
          "test_a_second_claim_by_another_account_is_rejected",
          "test_a_self_managed_record_is_not_claimable")),
    Rule("Slice 2 / DL-02",
         "Party and ownership are never inferred from a shared phone",
         ("test_a_customer_cannot_create_a_request_for_another_party",
          "test_claiming_does_not_infer_ownership_from_the_phone")),
    ...
    Rule("Slice 2 gap pinned",
         "No master reason code describes closing a REQUEST",
         ("test_no_master_reason_code_describes_closing_a_request",)),
